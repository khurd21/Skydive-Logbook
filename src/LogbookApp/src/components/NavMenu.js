...
const pages = [{ name: 'Home', route: '/' }, { name: 'Logbook', route: '/logbook' }, { name: 'Personal Info', route: '/personal-info' }];
const settings = [];
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={handleCloseUserMenu} component={Link} to={'/logbook'}>
